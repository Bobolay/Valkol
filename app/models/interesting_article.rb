class InterestingArticle < ActiveRecord::Base
  ...
  has_cache do
    pages self, :home, :interesting_articles, InterestingArticle.published
  end
  ...
  def url(locale = I18n.locale)
    ...
    Cms.url_helpers.send("interesting_article_#{locale}_path", id: url_fragment)
  end
end